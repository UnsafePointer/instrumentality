...
describe Instrumentality::Profile::Benchmark do
  context 'initialized with all available flags' do
    let(:params) do
      OpenStruct.new({'script' => Instrumentality::Constants::BENCHMARK_SCRIPT,
                      'process' => 'Instr',
    ...
    before do
      ...
      @subject = Instrumentality::Profile::Benchmark.new(argv)
    end
